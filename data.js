...
const ZONES = [
  // 왼쪽 하단(입구·서편)
  { id: "kid_forest",        name: "유아숲체험원",           color: "#6fa03c", x: 9,  y: 49, cat: "water" },
  { id: "research",          name: "연구동",                 color: "#7a8472", x: 17, y: 47, cat: "exhibit" },
  { id: "garden_mgmt",       name: "한국수목원정원관리원",   color: "#7a8472", x: 19, y: 53, cat: "exhibit" },
  { id: "greening_memorial", name: "국토녹화기념관",         color: "#8a6d3b", x: 20, y: 59, cat: "exhibit" },
  { id: "greenhouse",        name: "사계절전시온실",         color: "#3f9d5a", x: 26, y: 66, cat: "exhibit" },
  { id: "sense_garden",      name: "감각정원",               color: "#c47f3d", x: 31, y: 57, cat: "garden" },
  { id: "forest_garden",     name: "숲정원",                 color: "#3f9d5a", x: 25, y: 43, cat: "water" },
  { id: "hamyangji",         name: "함양지",                 color: "#3d7fd7", x: 17, y: 41, cat: "water" },
  // 중앙(하천·전통정원)
  { id: "cheongryu",         name: "청류지원",               color: "#3d7fd7", x: 33, y: 47, cat: "water" },
  { id: "festival_yard",     name: "축제마당",               color: "#d18e1c", x: 36, y: 57, cat: "flower" },
  { id: "flower_road",       name: "사계절꽃길",             color: "#d75d7c", x: 36, y: 64, cat: "flower" },
  { id: "ifla_garden",       name: "세계조경가대회기념정원", color: "#6fa03c", x: 33, y: 68, cat: "garden" },
  { id: "garden_center",     name: "가든센터",               color: "#7a8472", x: 41, y: 67, cat: "facility" },
  { id: "visitor_center",    name: "방문자센터",             color: "#7a8472", x: 45, y: 71, cat: "facility" },
  { id: "ieum_garden",       name: "이음정원",               color: "#c47f3d", x: 44, y: 60, cat: "flower" },
  { id: "pine_road",         name: "큰키소나무길",           color: "#2f6d4f", x: 41, y: 53, cat: "flower" },
  { id: "traditional_seoseo",name: "한국전통정원(별서정원)", color: "#c47f3d", x: 40, y: 44 },
  { id: "wall_garden",       name: "담장정원",               color: "#8a6d3b", x: 37, y: 35, cat: "garden" },
  { id: "healing_garden",    name: "치유정원",               color: "#3f9d5a", x: 36, y: 31, cat: "garden" },
  { id: "successor_garden",  name: "후계목정원",             color: "#2f6d4f", x: 51, y: 61, cat: "flower" },
  { id: "traditional_gung",  name: "한국전통정원(궁궐정원)", color: "#c47f3d", x: 51, y: 45, cat: "garden" },
  { id: "bonsai",            name: "분재원",                 color: "#8a6d3b", x: 54, y: 37, cat: "garden" },
  // 중앙 상단(생태·주제원)
  { id: "pollinator",        name: "폴리네이터가든",         color: "#e0a92e", x: 51, y: 22, cat: "water" },
  { id: "amphibian",         name: "양서류관찰원",           color: "#3d7fd7", x: 58, y: 20, cat: "water" },
  { id: "wildflower",        name: "야생화원",               color: "#d75d7c", x: 62, y: 30, cat: "flower" },
  { id: "rare_greenhouse",   name: "희귀특산식물전시온실",   color: "#3f9d5a", x: 66, y: 26, cat: "exhibit" },
  { id: "rare_garden",       name: "희귀특산식물원",         color: "#6fa03c", x: 66, y: 34, cat: "flower" },
  { id: "kid_garden",        name: "어린이정원",             color: "#6fa03c", x: 61, y: 43, cat: "garden" },
  { id: "life_garden",       name: "생활정원",               color: "#c47f3d", x: 64, y: 50, cat: "garden" },
  { id: "share_garden",      name: "공유정원",               color: "#6fa03c", x: 69, y: 56, cat: "garden" },
  { id: "iris_garden",       name: "붓꽃원",                 color: "#7d5fd7", x: 72, y: 42, cat: "flower" },
  { id: "maple_garden",      name: "단풍정원",               color: "#c0392b", x: 75, y: 45, cat: "flower" },
  // 오른쪽 상단(동편)
  { id: "wetland_forest",    name: "습지형생태숲",           color: "#3d7fd7", x: 74, y: 12, cat: "water" },
  { id: "rose_of_sharon",    name: "무궁화원",               color: "#d75d7c", x: 79, y: 18, cat: "flower" },
  { id: "garden_plant_plot", name: "정원식물가늠터",         color: "#6fa03c", x: 86, y: 20, cat: "flower" },
  { id: "folk_plant",        name: "민속식물원",             color: "#2f6d4f", x: 84, y: 29, cat: "garden" },
  { id: "chisan",            name: "치산녹화원",             color: "#8a6d3b", x: 93, y: 24, cat: "water" },
];
